...
function buildHealthPayload() {
  ...
  return {
    ...
    port: PORT,
    providers: {
      local: { configured: Boolean(configs.local.candidates.length), candidates: configs.local.candidates, model: configs.local.model, roots: configs.local.roots, apps: configs.local.apps.map((item) => item.name) },
