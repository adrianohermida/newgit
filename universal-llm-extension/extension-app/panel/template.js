      ...
      <div class="header-right">
        <div class="provider-pill">
          ...
          <select id="provider-select" title="Selecionar provider LLM">
            ...
            <option value="cloud">Ai-Core Cloud</option>
