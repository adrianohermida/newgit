...
export function PublicacoesScreenBody(props) {
  const { actionState, activeJobId, adviseBackfillProgress, adviseLastCycleTotal, adviseLastRunAt, adviseMode, advisePersistedDelta, adviseSync, adviseTokenOk, backendHealth, blockingJob, canManuallyDrainActiveJob, candidateQueueErrorCount, candidateQueueMismatchCount, copilotContext, data, drainInFlight, executionHistory, formatDateTimeLabel, formatFallbackReason, formatSnapshotLabel, formatValidationMeta, getOperationalPlanStepState, handleAction, hasBlockingJob, hasMultipleBlockingJobs, healthSuggestedActions, isDockedPublicacoesView, isLightTheme, isResultView, jobs, latestHistory, latestJob, latestRemoteRun, limit, loadIntegratedDetail, loadOverview, loadPartesCandidates, loadProcessCandidates, noPublicationActivityTypeConfigured, operationalPlan, operationalStatus, pagedIntegratedRows, paresUnused, partesBacklogCount, partesPage, processNumbers, processPage, processCandidates, publicationActivityTypeHint, publicationActivityTypes, queueRefreshLog, queuesViewModel, remoteHealth, remoteHistory, runOperationalPlanStep, runPendingJobsNow, selectedPartesKeys, selectedProcessKeys, selectedProcessNumbers, selectedUnifiedNumbers, setLimit, setProcessNumbers, snapshotMesaIntegrada, snapshotPartes, snapshotProcessos, syncWorkerLastPublicacoes, updateView, view, pendingJobCount } = props;
