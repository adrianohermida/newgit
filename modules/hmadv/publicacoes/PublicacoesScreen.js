...
function PublicacoesContent() {
  ...
  return (
    <div className={`${isDockedPublicacoesView ? "flex min-h-full flex-1 flex-col gap-6" : isResultView ? "space-y-6" : "space-y-8"}`.trim()}>
      ...
      {view === "filas" ? (
        <>
          <PublicacoesQueuesView
            isLightTheme={isLightTheme}
            queueDiagnostics={queueDiagnostics}
            updateView={updateView}
            recurringPublicacoes={recurringPublicacoes}
            recurringPublicacoesFocus={recurringPublicacoesFocus}
            recurringPublicacoesBatch={recurringPublicacoesBatch}
            ...
            selectVisibleRecurringPublicacoes={selectVisibleRecurringPublicacoes}
            selectVisibleSevereRecurringPublicacoes={selectVisibleSevereRecurringPublicacoes}
            clearQueueSelections={clearQueueSelections}
            recurringPublicacoesActions={recurringPublicacoesActions}
            primaryPublicacoesAction={primaryPublicacoesAction}
            runPendingJobsNow={runPendingJobsNow}
            actionState={actionState}
            drainInFlight={drainInFlight}
            canManuallyDrainActiveJob={canManuallyDrainActiveJob}
            recurringPublicacoesChecklist={recurringPublicacoesChecklist}
            recurringPublicacoesSummary={recurringPublicacoesSummary}
            recurringPublicacoesBands={recurringPublicacoesBands}
            recurringPublicacoesGroups={recurringPublicacoesGroups}
            processCandidates={processCandidates}
            partesCandidates={partesCandidates}
            data={data}
            integratedFilters={integratedFilters}
            setIntegratedFilters={setIntegratedFilters}
            selectedUnifiedCount={selectedUnifiedCount}
            selectedUnifiedNumbers={selectedUnifiedNumbers}
            integratedQueue={integratedQueue}
            filteredIntegratedRows={filteredIntegratedRows}
            integratedSourceLabel={integratedSourceLabel}
            bulkValidationStatus={bulkValidationStatus}
            setBulkValidationStatus={setBulkValidationStatus}
            bulkValidationNote={bulkValidationNote}
            setBulkValidationNote={setBulkValidationNote}
            applyValidationToNumbers={applyValidationToNumbers}
            runBulkContactsReconcile={runBulkContactsReconcile}
            loadHeavyQueueReads={loadHeavyQueueReads}
            handleAction={handleAction}
            hasBlockingJob={hasBlockingJob}
            noPublicationActivityTypeConfigured={noPublicationActivityTypeConfigured}
            publicationActivityTypeHint={publicationActivityTypeHint}
            refreshIntegratedSnapshot={refreshIntegratedSnapshot}
            pagedIntegratedRows={pagedIntegratedRows}
            integratedPage={integratedPage}
            integratedPageSize={integratedPageSize}
            loadIntegratedDetail={loadIntegratedDetail}
            toggleUnifiedRow={toggleUnifiedRow}
            toggleIntegratedPage={toggleIntegratedPage}
            toggleIntegratedFiltered={toggleIntegratedFiltered}
            allIntegratedPageSelected={allIntegratedPageSelected}
            allFilteredSelected={allIntegratedFilteredSelected}
            goToIntegratedPreviousPage={goToIntegratedPreviousPage}
            goToIntegratedNextPage={goToIntegratedNextPage}
            integratedCanGoPrevious={integratedCanGoPrevious}
            integratedCanGoNext={integratedCanGoNext}
            ...
            selectedDetailPendingPartes={selectedDetailPendingPartes}
            selectedDetailLinkedPartes={selectedDetailLinkedPartes}
            toggleDetailPendingParte={toggleDetailPendingParte}
            toggleDetailLinkedParte={toggleDetailLinkedParte}
            toggleDetailPendingPage={toggleDetailPendingPage}
            toggleDetailLinkedPage={toggleDetailLinkedPage}
            linkPendingDetailPartes={linkPendingDetailPartes}
            moveLinkedDetailPartes={moveLinkedDetailPartes}
            reclassifyLinkedDetailPartes={reclassifyLinkedDetailPartes}
            unlinkLinkedPartes={unlinkLinkedDetailPartes}
            saveDetailContact={saveDetailContact}
            ...
            setSelectedPartesKeys={setSelectedPartesKeys}
            getPublicacaoSelectionValue={getPublicacaoSelectionValue}
            heavyQueuesEnabled={heavyQueuesEnabled}
          />
        </>
      ) : null}
