  ...
  return (
    <RequireAdmin>
      {(profile) => (
        ...
        >
          <div className="h-[calc(100vh-11rem)] min-h-[720px] overflow-hidden rounded-[30px] border border-[#1C2623] bg-[linear-gradient(180deg,rgba(11,15,14,0.98),rgba(7,10,9,0.98))] shadow-[0_24px_64px_rgba(0,0,0,0.24)]">
            <DotobotCopilot
              profile={profile}
