...
function InternoProcessosContent() {
  ...
  return <div className="space-y-8">
    <section className="rounded-[34px] border border-[#2D2E2E] bg-[radial-gradient(circle_at_top_left,rgba(197,160,89,0.12),transparent_35%),linear-gradient(180deg,rgba(13,15,14,0.98),rgba(8,10,10,0.98))] px-6 py-6 md:px-7">
      <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 opacity-65">A tela agora prioriza fila, acoes e retorno operacional. O objetivo aqui e operar lotes pequenos com contexto suficiente para corrigir Supabase, DataJud e Freshsales sem perder o fio da execucao.</p>
        </div>
      ...
      <div className="mt-6"><SectionNav items={[{ href: "#operacao", label: "Operacao" }, { href: "#filas", label: "Filas" }, { href: "#relacoes", label: "Relacoes" }, { href: "#resultado", label: "Resultado" }]} /></div>
    </section>
    ...
    <div id="operacao" className="grid gap-6 xl:grid-cols-2">
    ...
    <div id="filas" className="grid gap-6 xl:grid-cols-2">
    ...
    <div id="relacoes" className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
