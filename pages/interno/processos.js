        ...
        >
          <section className="space-y-4 border border-[#2D2E2E] bg-[rgba(13,15,14,0.96)] p-6 text-[#F4F1EA]">
            ...
            <p className="text-sm leading-7 text-[#C6D1CC]">
              A tela avançada de processos foi isolada temporariamente para estabilizar a compilação do projeto no ambiente Windows.
            </p>
            <p className="text-sm leading-7 text-[#A8B6B0]">
              O restante do painel interno continua disponível normalmente.
            </p>
          </section>
        </InternoLayout>
      )}
