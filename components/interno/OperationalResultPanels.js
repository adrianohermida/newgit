export function OperationalResultCard({
  ...
  return (
    <section className={`flex h-full flex-col rounded-[28px] border border-[#2D2E2E] bg-[linear-gradient(180deg,rgba(13,15,14,0.96),rgba(7,9,8,0.96))] p-5 shadow-[0_12px_36px_rgba(0,0,0,0.22)] ${className}`.trim()}>
      ...
      <div className="mt-5 flex-1 space-y-4 text-sm text-[#D7DDD8]">
...
export function OperationalHistoryCompactCard({
  ...
  return (
    <section className={`flex h-full flex-col rounded-[28px] border border-[#2D2E2E] bg-[linear-gradient(180deg,rgba(13,15,14,0.96),rgba(7,9,8,0.96))] p-5 shadow-[0_12px_36px_rgba(0,0,0,0.22)] ${className}`.trim()}>
      ...
      <div className="mt-3 flex-1 space-y-3 text-sm text-[#D7DDD8]">
        <div>
