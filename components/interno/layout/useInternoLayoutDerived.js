...
export function useInternoLayoutDerived(props) {
  ...
  return {
    ...
    copilotConsoleInset: isMobileShell ? 0 : desktopConsoleBarHeight + consoleDockInset + (isCopilotWorkspace ? 0 : 10),
    ...
    desktopConsoleStyle: !isMobileShell ? { left: `${consoleDockLeft + consoleDockInset}px`, right: `${consoleDockRight + consoleDockInset}px`, bottom: `${consoleDockInset}px`, height: consoleOpen ? `${consoleHeight}px` : "60px" } : undefined,
