    ...
    >
      <div
        className={`rounded-[24px] border px-4 py-4 ${
          isLightTheme
            ? "border-[#E4EAF1] bg-[radial-gradient(circle_at_top_left,rgba(197,160,89,0.10),transparent_42%),#FFFFFF]"
            : "border-[#253833] bg-[radial-gradient(circle_at_top_left,rgba(197,160,89,0.10),transparent_38%),rgba(255,255,255,0.02)]"
        }`}
      >
      ...
      <div className="mt-4 flex flex-col gap-3">
        <div className={`flex items-center gap-3 rounded-[18px] border px-3 ${isLightTheme ? "border-[#D7DEE8] bg-white" : "border-[#22342F] bg-[rgba(7,9,8,0.98)]"}`}>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <label className={`flex cursor-pointer items-center gap-2 rounded-full border px-3 py-1.5 text-xs ${isLightTheme ? "border-[#D7DEE8] bg-white text-[#6B7C88]" : "border-[#22342F] text-[#C5A059]"}`}>
