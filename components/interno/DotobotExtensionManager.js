...
export default function DotobotExtensionManager() {
  const { extensionReady, lastResponse, debugEvents, handshakeState, probeExtension } = useDotobotExtensionBridge();
  ...
  const status = useMemo(
    () => getStatusPresentation({ extensionReady, checking, consentGranted, error, handshakeState, lastResponse, browserOrigin }),
    [browserOrigin, checking, consentGranted, error, extensionReady, handshakeState, lastResponse]
  );
