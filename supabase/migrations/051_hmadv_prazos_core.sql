...
create unique index if not exists prazo_calculado_evento_unq
  on judiciario.prazo_calculado (
    processo_id,
    evento_tipo,
    coalesce(publicacao_id, '00000000-0000-0000-0000-000000000000'::uuid),
    coalesce(movimento_id, '00000000-0000-0000-0000-000000000000'::uuid),
    coalesce(audiencia_id, '00000000-0000-0000-0000-000000000000'::uuid)
  );
