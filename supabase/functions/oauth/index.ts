...
function resolveConfig(kind: OAuthKind) {
  ...
  const clientId = isContacts
    ? Deno.env.get('FRESHSALES_OAUTH_CONTACTS_CLIENT_ID') ?? Deno.env.get('FRESHSALES_CONTACT_OAUTH_CLIENT_ID') ?? Deno.env.get('FRESHSALES_OAUTH_CLIENT_ID') ?? ''
    : Deno.env.get('FRESHSALES_OAUTH_DEALS_CLIENT_ID') ?? Deno.env.get('FRESHSALES_DEAL_OAUTH_CLIENT_ID') ?? Deno.env.get('FRESHSALES_OAUTH_CLIENT_ID') ?? '';
  const clientSecret = isContacts
    ? Deno.env.get('FRESHSALES_OAUTH_CONTACTS_CLIENT_SECRET') ?? Deno.env.get('FRESHSALES_CONTACT_OAUTH_CLIENT_SECRET') ?? Deno.env.get('FRESHSALES_OAUTH_CLIENT_SECRET') ?? ''
    : Deno.env.get('FRESHSALES_OAUTH_DEALS_CLIENT_SECRET') ?? Deno.env.get('FRESHSALES_DEAL_OAUTH_CLIENT_SECRET') ?? Deno.env.get('FRESHSALES_OAUTH_CLIENT_SECRET') ?? '';
  const scopes = isContacts
    ? Deno.env.get('FRESHSALES_CONTACTS_SCOPES') ?? Deno.env.get('FRESHSALES_CONTACT_SCOPES') ?? Deno.env.get('FRESHSALES_SCOPES') ?? ''
    : Deno.env.get('FRESHSALES_DEALS_SCOPES') ?? Deno.env.get('FRESHSALES_DEAL_SCOPES') ?? Deno.env.get('FRESHSALES_SCOPES') ?? '';
