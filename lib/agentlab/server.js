...
function validateFreshchatApiConfig(baseUrl, token) {
  ...
  if (issues.length) {
    return {
      ...
      issues,
      message:
        "As credenciais configuradas parecem ser do SDK/widget do Freshchat e nao da API administrativa. Para o sync do AgentLab, use 'Your chat URL' e 'Your API Key' em Settings > Admin Settings > Website Tracking and APIs > API Settings.",
    };
  }
