...
export async function listAdminOperations({ modulo, limit = 20 } = {}) {
...
export async function runAdviseBackfill() {
  return hmadvFunction("sync-advise-backfill", {}, { method: "POST", body: {} });
}
