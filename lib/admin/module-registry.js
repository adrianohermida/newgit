const MODULE_REGISTRY = [
  ...
  {
    key: "market-ads",
    label: "HMADV Market Ads",
    routePath: "/interno/market-ads",
    category: "growth",
    keywords: ["market ads", "ads", "google ads", "meta ads", "instagram ads", "compliance oab", "trafego pago juridico"],
    capabilities: ["inteligencia_concorrencia", "geracao_ads", "compliance_oab", "ab_testing", "landing_pages"],
    quickMissions: [
      "Resuma quais campanhas juridicas devem ser escaladas ou pausadas hoje.",
      "Valide uma copy de anuncio pela lente do compliance da OAB.",
    ],
  },
  {
    key: "portal-home",
