      ...
      try {
        ...
        if (!response.ok || payload.ok === false) {
          if (
            ...
            effectivePath.includes("/functions/api/admin-dotobot-chat")
          ) {
            effectivePath = effectivePath.replace("/functions/api/admin-dotobot-chat", "/functions/api/admin-lawdesk-chat");
