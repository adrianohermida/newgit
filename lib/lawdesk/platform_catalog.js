...
export const DOTOBOT_EXTERNAL_APP_COVERAGE = [
  {
    ...
    localCoverage: [
      ...
      "sales_activities: list, publication/movement/audiencia creation",
  ...
  },
  {
    ...
    missingForTotalCoverage: [
      ...
      "cobertura de contacts, groups e message send/reply como tools dedicadas",
    ],
  },
  {
    app: "freshdesk",
    ...
    missingForTotalCoverage: [
      ...
      "ticket detail, update, assignment, notes, contacts, groups, agents",
      "cobertura total dos endpoints Freshdesk relevantes para operacao do escritorio",
    ],
  },
  {
    app: "google_calendar",
