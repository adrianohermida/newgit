...
export const HMADV_EDGE_FUNCTION_EXECUTION_MATRIX = [
  { name: "advise-ai-enricher", userFacing: true, class: "user_facing", mode: "edge_function", intent: "enrich_publications", dispatcherStatus: "cataloged", notes: "Enriquecimento semantico de publicacoes." },
  ...
  { name: "advise-sync", userFacing: true, class: "user_facing", mode: "edge_function", intent: "sync_publications", dispatcherStatus: "cataloged", notes: "Sincronizacao incremental." },
  ...
  { name: "datajud-search", userFacing: true, class: "user_facing", mode: "edge_function", intent: "datajud_search", dispatcherStatus: "cataloged", notes: "Consulta e persistencia DataJud." },
  ...
  { name: "fc-ingest-conversations", userFacing: true, class: "user_facing", mode: "edge_function", intent: "freshchat_ingest", dispatcherStatus: "cataloged", notes: "Ingestao de conversas." },
  { name: "fc-last-conversation", userFacing: true, class: "user_facing", mode: "edge_function", intent: "freshchat_last_conversation", dispatcherStatus: "cataloged", notes: "Ultima conversa do contato." },
  { name: "fc-update-conversation", userFacing: true, class: "user_facing", mode: "edge_function", intent: "freshchat_update_conversation", dispatcherStatus: "cataloged", notes: "Atualizacao de conversa." },
  ...
  { name: "processo-sync", userFacing: true, class: "user_facing", mode: "edge_function", intent: "process_sync", dispatcherStatus: "cataloged", notes: "Sincronizacao bidirecional de processo." },
  { name: "publicacoes-audiencias", userFacing: true, class: "user_facing", mode: "edge_function", intent: "extract_audiencias", dispatcherStatus: "cataloged", notes: "Extracao de audiencias." },
  { name: "publicacoes-freshsales", userFacing: true, class: "user_facing", mode: "edge_function", intent: "sync_publications_to_crm", dispatcherStatus: "cataloged", notes: "Publicacoes para CRM." },
  { name: "publicacoes-prazos", userFacing: true, class: "user_facing", mode: "edge_function", intent: "calculate_deadlines", dispatcherStatus: "cataloged", notes: "Calculo de prazos." },
  ...
  { name: "tpu-enricher", userFacing: true, class: "user_facing", mode: "edge_function", intent: "tpu_enrich", dispatcherStatus: "cataloged", notes: "Enriquecimento local TPU." },
  { name: "tpu-sync", userFacing: false, class: "admin", mode: "edge_function", intent: "tpu_sync", dispatcherStatus: "cataloged", notes: "Sincronizacao detalhada TPU." },
];
