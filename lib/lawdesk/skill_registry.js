...
export const SKILLS_CATALOG = {
  ...
  freshworks_operations: {
    ...
    Identifique se a solicitacao envolve contato, conta, conversa, ticket, activity ou OAuth.
    Responda de forma objetiva, deixando claro o que esta pronto, parcial ou pendente de integracao.`,
