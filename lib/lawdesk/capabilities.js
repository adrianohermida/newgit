...
import {
  buildHmadvEdgeFunctionExecutionSummary,
  listHmadvEdgeFunctionExecutionMatrix,
} from "./edge_function_matrix.js";
...
export function buildDotobotRepositoryContext(input = {}) {
  ...
  const edgeFunctionExecutionMatrix = listHmadvEdgeFunctionExecutionMatrix();
  const edgeFunctionExecutionSummary = buildHmadvEdgeFunctionExecutionSummary();
