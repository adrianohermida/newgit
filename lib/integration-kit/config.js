...
function buildCredentialChecklist(env = process.env) {
  const checks = [
    ...
    {
      system: "Freshsales Contacts",
      item: "Concluir authorize URL de contacts e obter refresh token segmentado",
      present: Boolean(cleanValue(env.FRESHSALES_CONTACTS_REFRESH_TOKEN)),
      help: "Necessario para reconciliar partes e popular o espelho freshsales_contacts sem fallback.",
    },
    {
      system: "Freshdesk",
      item: "Gerar API key",
