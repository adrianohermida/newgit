...
function resolveFreshworksConfig(env = process.env) {
  ...
  return {
    ...
    clientId: firstEnv(["FRESHWORKS_OAUTH_CLIENT_ID", "FRESHSALES_OAUTH_CLIENT_ID", "FRESHSALES_OAUTH_DEALS_CLIENT_ID", "FRESHSALES_OAUTH_CONTACTS_CLIENT_ID"], env),
    clientSecret: firstEnv(["FRESHWORKS_OAUTH_CLIENT_SECRET", "FRESHSALES_OAUTH_CLIENT_SECRET", "FRESHSALES_OAUTH_DEALS_CLIENT_SECRET", "FRESHSALES_OAUTH_CONTACTS_CLIENT_SECRET"], env),
