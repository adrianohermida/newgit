export const FALLBACK_BLOG_POSTS = [
  {
    slug: "5-sinais-de-que-voce-esta-no-limite-do-superendividamento",
    category: "SUPERENDIVIDAMENTO",
    date: "2023-10-15",
    title: "5 Sinais de que voce esta no Limite do Superendividamento",
    excerpt:
  ...
  {
    slug: "como-identificar-juros-abusivos-no-seu-contrato-de-financiamento",
    category: "REVISIONAL",
    date: "2023-10-12",
  ...
  {
    slug: "a-nova-lei-14181-e-seus-beneficios-para-o-consumidor-brasileiro",
    category: "LEIS",
    date: "2023-10-08",
    title: "A Nova Lei 14.181 e seus beneficios para o consumidor brasileiro",
    excerpt:
  ...
  {
    slug: "como-organizar-suas-financas-apos-uma-renegociacao-de-dividas",
    category: "DICAS",
    date: "2023-10-01",
    title: "Como organizar suas financas apos uma renegociacao de dividas",
    excerpt:
  ...
  {
    slug: "minimo-existencial-entenda-seus-direitos-na-lei-do-superendividamento",
    category: "SUPERENDIVIDAMENTO",
    date: "2023-09-25",
    title: "Minimo existencial: entenda seus direitos na lei do superendividamento",
    excerpt:
  ...
  {
    slug: "financiamento-de-veiculo-quando-e-possivel-revisa-lo-judicialmente",
    category: "REVISIONAL",
    date: "2023-09-20",
    title: "Financiamento de veiculo: quando e possivel revisa-lo judicialmente",
    excerpt:
    ...
    content: [
      "A revisao de financiamento de veiculo faz sentido quando existem sinais tecnicos de desequilibrio contratual, cobranças desproporcionais ou falhas relevantes de transparencia. O simples atraso no pagamento nao basta, mas contratos com custo excessivo e encargos mal apresentados merecem analise.",
