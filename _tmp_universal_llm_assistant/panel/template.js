export function buildPanelMarkup() {
  return `
    ...
    <section id="pane-settings" class="pane settings-pane">
      ...
      <div class="setting-section"><h4>Cloud</h4><label>URL da aplicacao<input id="input-app-url" /></label><label>Modelo cloud<input id="input-cloud-model" /></label><div class="test-row"><button id="btn-test-cloud" class="btn-test">Testar conexao</button><span id="test-cloud-result" class="test-result"></span></div></div>
      <div class="setting-section"><h4>Cloudflare</h4><label>Modelo Workers AI<input id="input-cf-model" /></label><div class="test-row"><button id="btn-test-cf" class="btn-test">Testar conexao</button><span id="test-cf-result" class="test-result"></span></div></div>
